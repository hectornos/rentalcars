...
<div class="container">
  <h1 class="page-header">Agregar un cliente</h1>
      <form action="{{ route('Cliente.store2')}}" method="POST" id="formulario" onsubmit="return validarCliente()">
          {{ csrf_field() }}
          ...
          <div class="form-group">
              ...
              <div class="col-10">
              <input readonly class="form-control" type="text" value="{{$dni}}" id="dni" name="dni">
              </div>
          </div>
          <div class="form-group">
          ...
          <br>
          <div class="btn-group">
              <button class="btn btn-success" type="submit" name="seguir" value="seguir">
                  <span class="glyphicon glyphicon-ok"></span> Seguir</button>           
          </div>
      </form>          
  </div>
